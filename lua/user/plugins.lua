...
return packer.startup(function(use)
  ...
  -- Not sure what this does entirely, fills some gap
  use("lvimuser/lsp-inlayhints.nvim")

  -- Ever accidentally open a file in something like the NvimTree window? this stops that
  use("stevearc/stickybuf.nvim")

  -- Decorate a status bar with some LSP structural breadcrumbs
